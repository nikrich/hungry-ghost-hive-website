  ...
  return (
    <>
      <button
        ...
        disabled
        className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-xs bg-gray-light text-body-color cursor-not-allowed opacity-50 dark:bg-gray-dark sm:ml-3"
      >
        <svg
          width="16"
          height="16"
      ...
      <button
        aria-label="social-share"
        disabled
        className="mb-3 ml-3 inline-flex h-9 w-9 items-center justify-center rounded-xs bg-gray-light text-body-color cursor-not-allowed opacity-50 dark:bg-gray-dark"
      >
        <svg
          width="18"
          height="18"
